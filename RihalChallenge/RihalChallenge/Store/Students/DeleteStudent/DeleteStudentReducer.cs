...
public static class DeleteStudentReducer
{
    ...
    {
        return new StateStore(state.Students,true,null,null,null,null,null,null,null,null);
    }

    [ReducerMethod]
    public static StateStore ReduceDeleteStudentResultAction(StateStore state, DeleteStudentResultAction action)
    {
        return new StateStore(action.Students, false,null,null,null,null,null,null,null,null);
    }
}